...
class Author(models.Model):
    ...
    total_book_written = models.CharField(max_length=1, choices=numChoice, default=0)
...
class Borrow(models.Model):
    name = models.CharField(max_length=100, help_text='Book Name',null=True)
    timestamp = models.DateTimeField(auto_now=True)
    date_in= models.DateField(null=False, blank=False)
    date_out= models.DateField(null=False, blank=False)
    status=models.CharField(max_length=1, help_text='y for yes n for no',null=False,default=0)
    def __str__(self):
        return self.name 
